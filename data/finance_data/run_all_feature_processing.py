...
def run_financial_processing_scripts(target_col: str):
    ...
    """
    scripts_with_args = {
        "data/finance_data/0_target_shift_processing.py": ["--target-column", "{target}_stockprice"],
        "data/finance_data/1_feature_moving_averages_processing.py": ["--columns", "{target}_stockprice"],
        "data/finance_data/2_feature_macd_processing.py": ["--columns", "{target}_stockprice"],
        "data/finance_data/3_feature_rsi_processing.py": ["--columns", "{target}_stockprice"],
        "data/finance_data/4_feature_bollinger_bands_processing.py": ["--columns", "{target}_stockprice"],
        ...
        "data/finance_data/9_feature_momentum_roc_processing.py": ["--columns", "{target}_stockprice"],
